...
export const userPreferences = pgTable("user_preferences", {
  ...
  currentTopic: text("current_topic"), // Universal: any learning topic
...
export const srsCard = pgTable(
  "srs_card",
  {
    word: text("word").notNull(), // term/word stored lowercase
    language: text("language").notNull(), // kept for backward compat
    topic: text("topic"), // Universal: group by any topic
    userId: text("user_id")
      .notNull()
      .references(() => user.id, { onDelete: "cascade" }),
    translation: text("translation").notNull(), // definition/translation
...
export const course = pgTable("course", {
  ...
  topic: text("topic").notNull(), // Universal: "German", "MedAT", "Quantum Physics"
  sourceLanguage: text("source_language"), // Optional: only for language courses
  targetLanguage: text("target_language"), // Optional: only for language courses
...
export const unit = pgTable("unit", {
  ...
  topic: text("topic").notNull(), // Universal: "German", "MedAT Biology", "Quantum Physics"
  targetLanguage: text("target_language"), // Optional: only for language units
  sourceLanguage: text("source_language"), // Optional: only for language units
  level: text("level"),
  visibility: text("visibility"),
  createdBy: text("created_by").references(() => user.id, {
    onDelete: "set null",
