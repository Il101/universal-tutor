  ...
  return (
    <div className="mx-auto max-w-2xl py-6">
      ...
      <p className="text-sm text-lingo-text-light font-bold mb-6">
        Customize your learning preferences and AI settings.
      </p>

      {/* Language settings */}
      <div className="rounded-2xl border-2 border-lingo-border bg-white p-5 mb-6 space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-sm font-bold text-lingo-text-light">Learning Topic</span>
          <select
          ...
          >
            <option value="" disabled>Select a topic/language</option>
